               ...
               <div class="flex-1">
                  ...
                  <div class="mt-3 flex items-center space-x-2">
                     <button @click="toggleLike(index)"
                        ...
                        :class="{ 'font-semibold': comment.commentLikedBy.includes(currentUser.userid) }">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4"
                           :class="{ 'fill-black': comment.commentLikedBy.includes(currentUser.userid), 'fill-gray-500': !comment.commentLikedBy.includes(currentUser.userid) }"
