<template>
   <div class="container mx-auto px-4 py-8 flex flex-col items-center">
      <!-- Card Container -->
      <div class="bg-white p-8 backdrop-blur-lg rounded-lg shadow-2xl max-w-[1200px] w-full">
         <!-- Header Section -->
            ...
            <div>
               ...
               <div class="grid grid-cols-1 gap-6">
                  <div>
                     ...
                     <select v-model="settings.postsOnHomePage" class="mt-2 mb-2 p-2 block w-auto rounded-lg border-gray-300 shadow-sm focus:ring-black focus:border-black">
                  ...
                  <div>
                     ...
                     <select v-model="settings.language" class="mt-2 p-2 block w-auto rounded-lg border-gray-300 shadow-sm focus:ring-black focus:border-black">
            ...
            <div>
               ...
               <div class="grid grid-cols-1 gap-6">
                  <div>
                     ...
                     <select v-model="settings.theme" class="mt-2 p-2 block w-auto rounded-lg border-gray-300 shadow-sm focus:ring-black focus:border-black">
            ...
            <div>
               ...
               <div class="grid grid-cols-1 gap-6">
                  ...
                  <div>
                     ...
                     <select v-model="settings.newColleagueNotifications" class="mt-2 p-2 block w-auto rounded-lg border-gray-300 shadow-sm focus:ring-black focus:border-black">
                  ...
                  <div>
                     ...
                     <select v-model="settings.birthdayNotifications" class="mt-2 p-2 block w-auto rounded-lg border-gray-300 shadow-sm focus:ring-black focus:border-black">
                        <option value="all">All</option>
                        <option value="location">Your Location</option>
                        <option value="none">None</option>
                     </select>
            ...
            <div>
               ...
               <div class="grid grid-cols-1 gap-6">
                  <div>
                     ...
                     <select v-model="settings.calendarSettings" class="mt-2 p-2 block w-auto rounded-lg border-gray-300 shadow-sm focus:ring-black focus:border-black">
